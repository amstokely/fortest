module test_assert_test_fixture_mod
    ...
    use assert_mod,   only : assert_equal, assert_not_equal, assert_true, assert_false
    implicit none
...
program test_assert_test_fixture
    ...
    use test_session_mod, only : test_session_t, test_suite_t
    ...
    call test_session%register_fixture( &
            "test_suite", "assert_fixture", &
            setup_assert_fixture, teardown_assert_fixture, &
            assert_fixture_ptr, "test")
