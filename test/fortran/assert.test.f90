...
program test_assert
   ...
   call test_suite%register_test("test_assert_equal_int",    test_assert_equal_int)
   ...
   call test_suite%register_test("test_assert_not_equal_int",    test_assert_not_equal_int)
   call test_suite%register_test("test_assert_not_equal_float",  test_assert_not_equal_float)
   call test_suite%register_test("test_assert_not_equal_double", test_assert_not_equal_double)
   call test_suite%register_test("test_assert_not_equal_string", test_assert_not_equal_string)
   call test_suite%register_test("test_assert_true",  test_assert_true)
   call test_suite%register_test("test_assert_false", test_assert_false)
   call test_suite%run()
   call test_suite%finalize()
